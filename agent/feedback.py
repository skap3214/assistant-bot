...
class FeedbackAgent:
    ...
    solve problems and do tasks for the user. Your job as the Feedback Agent is to update/provider feedback in a manner that helps the Planner Agent and Executor Agent to plan out tasks and steps more efficiently and error free.
    ...
    The user interaction consists of input from the user, steps taken by the Executor Agent, and output.
